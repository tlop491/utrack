...
import getStylesCreator from './getStylesCreator'; // We use the same empty object to ref count the styles that don't need a theme object.

const noopTheme = {}; // Helper to debug
// let id = 0;
...
function makeStyles(stylesOrCreator, options = {}) {
  const {
    ...
    name
        ...
        stylesOptions2 = _objectWithoutProperties(options, ["withTheme", "name"]);
  ...
  return (props = {}) => {
    ...
    const stylesOptions = _objectSpread({}, React.useContext(StylesContext), stylesOptions2);

    let firstRender = false;
    const [state] = React.useState(() => {
      firstRender = true;
      return {// Helper to debug
        // id: id++,
      };
