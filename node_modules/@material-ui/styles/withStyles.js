...
var _getDynamicStyles = _interopRequireDefault(require("jss/lib/utils/getDynamicStyles"));
...
function attach(_ref2) {
  ...
  if (sheetManager.refs === 0) {
    ...
    sheetManager.dynamicStyles = (0, _getDynamicStyles.default)(styles);
  ...
  return function (Component) {
    ...
    var WithStyles = _react.default.forwardRef(function (props, ref) {
      return _react.default.createElement(_StylesProvider.StylesContext.Consumer, null, function (stylesOptions1) {
        ...
        return listenToTheme ? _react.default.createElement(_ThemeProvider.ThemeContext.Consumer, null, function (theme) {
