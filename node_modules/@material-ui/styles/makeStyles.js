...
function makeStyles(stylesOrCreator) {
  ...
  return function () {
    ...
    var theme = listenToTheme ? _react.default.useContext(_ThemeProvider.ThemeContext) : noopTheme;
    ...
    var _React$useState = _react.default.useState(function () {
      ...
      return {};
        ...
        state = _React$useState2[0]; // Execute synchronously everytime the theme changes.
