...
export class Dashboard extends React.Component<IProps, IState> {
    ...
    public renderSquare(url: any, title: any, category:any, date:any){
        ...
        return <PdfDisplayFactory url={url} title={title} category={category}  date={date} />;
    ...
    public render() {
        ...
        return (
            ...
            {this.state.auth && (
                ...
                <ListSection studentSubjectONE={this.props.studentSubjectONE} studentSubjectTWO={this.props.studentSubjectTWO} studentSubjectTHREE={this.props.studentSubjectTHREE} studentSubjectFOUR={this.props.studentSubjectFOUR} docCatergories={this.props.docCatergories}/>
                ...
                {/* Loop through the array and for each element call a method that creates a new pdf instance and passes date, title and others */}

                {this.renderSquare("testURl", "titletest", "testcategory", "testdate")}
